...
object Intro extends App {
  ...
  val aThread = new Thread(runnable) //Java threads

  aThread.start() // gives the  signal to the JVM to start a JVM thread
  //difference between thread instance and an actual JVM thread call run  methhod to start stuff in paralell
  ...
  // executors - in Java threads are expensive to create and killl
